...
<<<<<<< HEAD
        ...
        <!-- <router-link :to="url">我是投票</router-link> -->
       <foot></foot> 
=======
        <div class="content">
            <div class="container">
                ...
                <p>2018 Hyundai Blue Prize 诚挚的邀请您加入本届赛事的评委阵营,您的一票或许将决定最终的大赛结果。</p>

                <p>投票时间 : 10月1日 - 10月31日</p>
                
                <p>投票分<span>大众投票</span>和<span>媒体投票</span></p>

                <p>所有的线上网友均可为您喜欢的参展人投票,分值权重15%。</p>
